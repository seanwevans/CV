...
\begin{table}[]
	\begin{tabular*}{\textwidth}{c @{\extracolsep{\fill}} r}
		...
		\begin{tabular}[r]{@{}r@{}} 
			...
			\includegraphics[scale=0.05]{email.png} \href{mailto:sean@seanwevans.com}{\textbf{\textsc{sean@seanwevans.com}}} \\ 
			\includegraphics[scale=0.02]{web.png} \href{http://seanwevans.com}{\textbf{\textsc{http://seanwevans.com}}}  
		\end{tabular} 
	\end{tabular*}
\end{table}
